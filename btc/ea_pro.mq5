...
input double baseStopLossPercent  = 1.5;        // ✅ [M15] 平衡型止损 1.5% [cite: 22]
input double heavyPosStopLoss     = 1.0;        // ✅ [M15] 重仓止损 1.0% [cite: 23]
...
input double trailingStartPercent = 1.2;        // ✅ [M15] 启动阈值 1.2% [cite: 24]

input group  "=== 分级回撤宽容度 (Gap) ==="
input double trailGap_Level1      = 0.4;        // ✅ [M15] 初期回撤 0.4% [cite: 25]
input double trailGap_Level2      = 0.6;        // ✅ [M15] 中期回撤 0.6% [cite: 26]
input double trailGap_Level3      = 1.0;        // ✅ [M15] 后期回撤 1.0% [cite: 27]
